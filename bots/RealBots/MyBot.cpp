...
double othelloBoardEvaluator(char grid[8][8])  {
    ...
    // double score = (11 * p) + (850.724 * c) + (382.026 * l) + (86.922 * m) + (78.396 * l) + (10 * d);
    //[winner in red] 
    double score = (11 * p) + (850.724*25 * c) + (382.026*10 * l) + (86.922 * m) + (78.396 * f); //(10 * d);
    // double score = (10 * p) + (2000 * c) + (500 * l) + (100 * m) + (50 * f);
    return score;
}
